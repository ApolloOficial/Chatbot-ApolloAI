...
class Config:
    ...
    AWS_MONTHLY_COST_100_USERS = float(os.getenv("AWS_MONTHLY_COST_100_USERS", "12.80"))
    AWS_MONTHLY_COST_1000_USERS = float(os.getenv("AWS_MONTHLY_COST_1000_USERS", "20.40"))
